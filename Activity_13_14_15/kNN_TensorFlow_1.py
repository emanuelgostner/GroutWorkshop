...
def create_data_points():
    ...
    mu0 = [-0.5, 5]
    covar0 = [[1.5, 0], [0, 1.5]]
    # Nimmt einen Punkt mu0 und erstellt 100 random verteilte andere Punkte run um mu0 um einen Cluster zu simulieren
    # returnt eine Menge an Vektoren
    x0 = np.random.multivariate_normal(mu0, covar0, num_points_cluster0)
    # Array mit lauter 0er erstellen (steht für die Klasse der [x,y] Daten in x0
