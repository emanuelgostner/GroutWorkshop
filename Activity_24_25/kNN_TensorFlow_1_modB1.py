# ------------------------------------------------------------------
# Filename:    kNN_TensorFlow_1_modB1.py
# ------------------------------------------------------------------
# File description:
...
def create_test_point_to_classify(x, y):
...
def argument_parser():
    ...
    parser.add_argument('-k', metavar='<int>', type=int, help='k value used by the algorithm')

    args = parser.parse_args()
    k_value_tf = tf.constant(args.k)
    return args.x, args.y, k_value_tf
...
def main():
    ...
    (x, y, k_value_tf) = argument_parser()
    print('----------------------------------------------------')
    ...
    (data_point, data_point_tf) = create_test_point_to_classify(x, y)
